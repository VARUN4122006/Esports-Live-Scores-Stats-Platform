...
const PlayerProfile = () => {
    ...
    useEffect(() => {
        ...
        // Check all data sources - we only have valorantData imported here for now for the mock
        // In a real implementation we'd check all data sources or have a unified player store
        let found = valorantData.players.find(p => p.name.toLowerCase() === playername.toLowerCase());
    ...
    return (
        <div className="min-h-screen bg-bg-dark text-white pt-24 pb-20 font-sans animate-fade-in">
